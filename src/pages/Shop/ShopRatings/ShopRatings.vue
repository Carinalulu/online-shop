  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <Star :score="info.serviceScore" :size="24" />
            <span class="score">{{info.serviceScore}}</span>
          </div>
          <div class="score-wrapper">
            <span class="title">商品评分</span>
            <Star :score="info.foodScore" :size="24" />
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{'on': onlyShowContent}" @click="toggleOnlyShow">
...
export default{
  data () {
    return {
      onlyShowContent: false, // 是否只看有内容的评价
  ...
  computed: {
    ...
    filterRatings () {
      const {ratings, onlyShowContent, selectType} = this
