<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}">
      <a class="back" @click="$router.back()"><i class="iconfont icon-arrow_left"></i></a>
    </nav>
    <div class="shop-content">
      <img class="content-image" :src="info.avatar">
      <div class="header-content" @click="infoShowClick">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="supportShowClick">
    ...
    <div class="shop-brief-modal" v-show="infoShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="infoShowClick">
    ...
    <div class="activity-sheet" v-show="supportShow">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" v-for="(support,index) in info.supports" :key="index" :class="supportClass[support.type]">
        ...
        <div class="activity-sheet-close" @click="supportShowClick">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
