<template>
  <div>
    <div class="shopcart">
      <div class="content">
        <div class="content-left" @click="clickShopCartShow">
          ...
          <div class="price" :class="{highlight: totalCount}">￥{{info.minPrice}}</div>
              ...
              <li class="food" v-for="(food,index) in cartFoods" :key="index">
                ...
                <div class="cartcontrol-wrapper">
                  <div class="cartcontrol">
                    <div class="iconfont icon-remove_circle_outline" @click.stop="updateFoodCount(false,food)"></div>
    ...
    <transition name="fade">
      <div class="list-mask" v-show="listShow" @click="clickShopCartShow"></div>
    </transition>
  </div>
</template>
<script>
...
export default{
  ...
  methods: {
    ...
    updateFoodCount (isAdd, food) {
      this.$store.dispatch('updateFoodCount', {isAdd, food: food})
    },
    clearShopCart () {
